# Generated by Django 5.1.7 on 2025-05-27 15:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'Active'), (2, 'Expired'), (3, 'Cancelled'), (4, 'Pending')], default=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reviews', to='gymcareapp.member')),
                ('trainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='gymcareapp.trainer')),
                ('training_package', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='gymcareapp.trainingpackage')),
            ],
            options={
                'ordering': ['-id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Scheduled'), (1, 'Completed'), (2, 'Cancelled'), (3, 'Pending_change'), (4, 'Changed'), (5, 'Approved')], default=0)),
